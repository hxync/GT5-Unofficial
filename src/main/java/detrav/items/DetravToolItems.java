...
public final class DetravToolItems {
    ...
    public static void register() {
        PROSPECTOR_LV = prospector("detrav.metatool.01.prospector_lv", 1, IDDetraveMetaGeneratedTool01.ProspectorScannerLV.ID);
        PROSPECTOR_MV = prospector("detrav.metatool.01.prospector_mv", 2, IDDetraveMetaGeneratedTool01.ProspectorScannerMV.ID);
        PROSPECTOR_HV = prospector("detrav.metatool.01.prospector_hv", 3, IDDetraveMetaGeneratedTool01.ProspectorScannerHV.ID);
        PROSPECTOR_EV = prospector("detrav.metatool.01.prospector_ev", 4, IDDetraveMetaGeneratedTool01.ProspectorScannerEV.ID);
        PROSPECTOR_IV = prospector("detrav.metatool.01.prospector_iv", 5, IDDetraveMetaGeneratedTool01.ProspectorScannerIV.ID);
